...
E.prototype._next = function(rv){
    ...
    {
        var ret = states[this._ensure].f.call(this);
        if (E.is_err(ret))
...
E.prototype._set_wait_child = function(wait_obj){
    ...
    var cond = wait_obj.cond, wait_on;
...
E.prototype.wait_child = function(child, timeout, cond){
    ...
    return {id: wait_obj, timeout: timeout, op: 'wait_child',
        child: child, at_child: null, cond: cond};
};
...
E.prototype._assert_tree = function(opt){
    ...
    if (this.child_guess.length)
        assert(E.in_run.indexOf(this)>=0);
...
E.prototype._assert_parent = function(){
    ...
    else if (this.parent_guess)
    {
        ...
        assert(E.in_run.indexOf(this.parent_guess)>=0);
    }
};
...
E.efor = function(cond, inc, opt, et_states){
    if (Array.isArray(opt))
    {
        et_states = opt;
        opt = {};
...
E.efor_each = function(obj, et_states){
